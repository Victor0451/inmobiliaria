...
class ContratoDeptoMono extends Component {
state = {
locatario: {},
locatario2: {},
unidadFuncional: {},
...
<div className="container">
    <div id="contrato">
        ...
        <p className="text-justify">
            ...
            marca ferrum) y correctamente pintada y aseada, dando en este acto su mas absoluta conformidad a lo que aquí
            se manifiesta, comprometiéndose a restituirla al término de la locacion en las mismas condiciones en que la
            recibió y pintada con la misma calidad de pintura.
        </p>
