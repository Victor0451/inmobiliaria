...
<div className="container">
    <div id="contrato">
        ...
        <p className="text-justify">
            ...
            comprometiéndose a restituirla al término de la locacion en las mismas condiciones en que la recibió y
            pintada con
        ...
        <p className="text-justify">
            ...
            cualquier tipo
            y especie en el inmueble, sin autorización por escrito del locador. Todas las mejoras autorizadas que se
            realicen
            en las unidad funcional arrendada, aún con autorización de El Locador, quedaran en beneficio de la propiedad
            sin
            ...
            responsabilizan por todos los daños que ocasionen no solo en la unidad funcional si no también en los
            espacios
            comunes del edificio de calle OTERO Nº 464 de esta ciudad. Como respaldo a esto se detalla a continuación
            los
            elementos que se encuentran en los espacios comunes, los cuales son: trece (13) unidades de Luces de
            Emergencia de
            100 LED, marca ALIC; veintiún (21) artefactos de embutir redondo para dos lamparas, marca BAP; cuatro (4)
            unidades
            de Artefactos 36 x3 con sus respectivas lamparas marca BAP; doce (12) unidades de Artefactos 26 x2 con sus
            respectivas lamparas marcas BAP; Todos los espacios pintados con pintura de la marca Murella código 6084;
            una (1)
            puertas de aluminio negro con vidrio; cuatro (4) puertas ventanas de aluminio negro con vidrio; veinticuatro
            (24)
            ventanas de aluminio negro con vidrio; Seis (6) puertas de baños de marca Oblack, completas con vidrio,
            picaporte
            y cerraduras; Seis (6) Inodoros con tabla de madera, mochila y lavatorios Ferrum con gritería tipo
            prismática
            marca FV; trece (13) llaves de un puntos; doce (12) llaves de dos puntos; cuatro (4) llaves de tres puntos;
            (8)
