...
//     const respuesta = await axios.get("http://192.168.1.100:3002/getlistadotitulares");
//     dispatch({
...
export const mostrarLocador = id => async dispatch => {
    const respuesta = await axios.get(`http://192.168.1.100:5000/getlocadorselect/${id}`);
...
//     const respuesta = await axios.get(`http://192.168.1.100:3002/getdatostitular/${id}`);
