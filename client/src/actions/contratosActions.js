...
export const mostrarContratos = () => async dispatch => {
    const respuesta = await axios.get("http://192.168.1.100:5000/getcontratos");
    dispatch({
...
export const mostrarContrato = id => async dispatch => {
    const respuesta = await axios.get(`http://192.168.1.100:5000/getcontratoselect/${id}`);
...
export const mostrarContratosVencidos = (fecha) => async dispatch => {
    const respuesta = await axios.get(`http://192.168.1.100:5000/getcontratosvencidos/${fecha}`);
    dispatch({
...
export const agregarContrato = contrato => async dispatch => {
    const respuesta = await axios.post(
        "http://192.168.1.100:5000/postcontrato",
        contrato
    );
...
export const agregar2Locatario = contrato => async dispatch => {
    ...
    const respuesta = await axios.put(
        `http://192.168.1.100:5000/putlocatario/${contrato.id_contrato}`,
        contrato
    );
