...
export default class FormLocatarioContrato extends Component {
  ...
  render() {
    ...
    const { leerDatos, unidadFuncional, id_contrato, crearLocatarioContrato, crearLocatarioContrato2 } = this.props
        ...
        <div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <p className="has-dynamic-label">
                <select id="dynamic-label-input" onChange={leerDatos} defaultValue={"Default"} className="" name="tipo"  >
                  <option selected value="Default">Tipo de contrato</option>
                  <option value="contrato">Oficina Sin Baño</option>
                  <option value="oficonbaño" >Oficina Con Baño</option>
                  <option value="localconbaño" >Local Con Baño</option>
