    ...
    render() {
      ...
      <strong>${contrato.pagos_contrato + 660}</strong>). Como complemento
                    ...
                    <p className="text-justify">
                        ...
                        ccon todos los herrajes, con todos los herrajes, un portero eléctrico, llaves, artefactos de iluminación y
                        correctamente pintada y aseada, dando en este acto su mas absoluta conformidad a lo que aquí se manifiesta,
                        comprometiéndose a restituirla al término de la locacion en las mismas condiciones en que la recibió y pintada con
                    ...
                    <p className="text-justify">
                        <u>SEPTIMA:</u> Los locatarios no podrán introducir cambios, reformas, mejoras o modificaciones, de cualquier tipo
                        y especie en el inmueble, sin autorización por escrito del locador. Todas las mejoras autorizadas que se realicen
                        en las unidad funcional arrendada, aún con autorización de El Locador, quedaran en beneficio de la propiedad sin
                        derecho a solicitar reintegro todo esto sin perjuicio de que el mismo (refiere El locador) puede exigir la
                        inmediata restitución al estado anterior a costa exclusiva de los locatarios. Ellos (los locatarios) se
                        responsabilizan por todos los daños que ocasionen no solo en la unidad funcional si no también en los espacios
                        comunes del edificio de calle OTERO Nº 464 de esta ciudad. Como respaldo a esto se detalla a continuación los
                        elementos que se encuentran en los espacios comunes, los cuales son: trece (13) unidades de Luces de Emergencia de
                        100 LED, marca ALIC; veintiún (21) artefactos de embutir redondo para dos lamparas, marca BAP; cuatro (4) unidades
                        de Artefactos 36 x3 con sus respectivas lamparas marca BAP; doce (12) unidades de Artefactos 26 x2 con sus
                        respectivas lamparas marcas BAP; Todos los espacios pintados con pintura de la marca Murella código 6084; una (1)
                        puertas de aluminio negro con vidrio; cuatro (4) puertas ventanas de aluminio negro con vidrio; veinticuatro (24)
                        ventanas de aluminio negro con vidrio; Seis (6) puertas de baños de marca Oblack, completas con vidrio, picaporte
                        y cerraduras; Seis (6) Inodoros con tabla de madera, mochila y lavatorios Ferrum con gritería tipo prismática
                        marca FV; trece (13) llaves de un puntos; doce (12) llaves de dos puntos; cuatro (4) llaves de tres puntos; (8)
                        tomas corrientes; seis (6) tapas ciegas; dos (2) termotanques eléctricos de marca Rheem de 125 litros.
    </p>
