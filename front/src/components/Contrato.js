...
export default class Contrato extends Component {
  render() {
    ...
    let locatario = this.props.locatario;
    ...
    return (
      <div className="container">
        ...
        <p className="text-justify mt-4">
          ...
          <strong>{monthname}</strong> de <strong>{year}</strong>, entre la Sr/a
          AMELIA BUSIGNANI, DNI 24.399.134 con domicilio en calle LAMADRID N°188
          de Ciudad de san salvador de jujuy –Provincia de Jujuy- , en adelante
          denominado el LOCADOR, por una parte; y por la otra
          ...
          salvador de jujuy, –Provincia de Jujuy-, y el Sr. FARFAN EDUARDO RENE,
          CUIT 20-10853949-7 con domicilio en Ricardo hueda n°42 - B° AMPUAP
          bajo la viña – san salvador de jujuy, –Provincia de Jujuy- en adelante
          los “LOCATARIOS”, se conviene en celebrar el presente Contrato de
          Locación Comercial, el que se regirá conforme a las siguientes
          cláusulas:
        </p>

        <p className="text-justify">
          PRIMERA: El locador da en arriendo a los locatarios y estos aceptan,
          la unidad funcional n°29, identificada del piso 2º (segundo piso), que
          se disgregan del edificio situado en OTERO Nº 464 de esta ciudad,
          fijándose como fecha de iniciación de este contrato el día 01/05/2019,
          fecha a la cual retrotraen los efectos de este contrato. Todos los
          montos que se consignan a continuación en el presente contrato, no
          incluyen IVA (impuesto al valor agregado). En este acto el locador
          recibe del locatario la suma de pesos: CUATRO MIL ($4.000). Sirviendo
          la presente de suficiente recibo por dicho importe, aplicado a los
          siguientes conceptos: la suma de pesos: DOS MIL ($2.000-) en concepto
          de pago anticipado de un mes de alquiler, correspondiente al mes de
          mayo del año 2019 y la suma de pesos: DOS MIL ($2.000-), en concepto
          de deposito de garantía, los cuales serán devueltos al finalizar el
