    ...
    return (
      <div className="container" id="imprimir">
        ...
        <p className="text-justify mt-4">
          ...
          adelante el “LOCATARIO”, se conviene en celebrar el presente Contrato
          de Locación Comercial, el que se regirá conforme a las siguientes
          cláusulas:
        </p>
        ...
        <p className="text-justify">
          ...
          serán abonados por los locatarios.
        </p>
        <p className="text-justify">
          SEGUNDA: el termino de la Locacion será de dos (2) años a partir de la
          fecha citada, feneciendo el 30/04/21. A su vencimiento, si los
          locatarios desearan continuar en la locacion, se celebrara un nuevo
          contrato. Se pacta expresamente que los locatarios podrán rescindir la
          contratación luego de transcurridos seis (6) meses de locación,
          debiendo notificar fehacientemente su decisión al locador con una
          antelación mínima de sesenta (60) días de la fecha en que reintegrara
          el inmueble locado. Los locatarios deberán abonar el valor equivalente
          a 1 (un) mes y medio de alquiler si la rescisión se produce dentro del
          primer año de contrato, y de 1 (un) mes de alquiler si se produce
          después del primer año, en concepto de indemnización.--
        </p>
        <p className="text-justify">
          TERCERA: Los Locatarios se comprometen a abonar por la unidad
          funcional que arriendan la suma de DOS MIL ($2.000-) mensuales,
          pagaderos por mes adelantado del 1 al 10 de cada mes, en calle LAVALLE
          Nº 123 de esta ciudad o donde el locador indique, además y como
          formando parte de la locacion los locatarios abonaran al Locador en el
          mismo termino, las expensas comunes por, limsa, impuestos
          inmobiliario, luz, agua, gas, que forman parte de dicha expensas,
          Internet y todo cuando otro gasto común que se realice para el buen
          funcionamiento y aseo de las unidades funcionales de los pisos del
          edificio. Los locatarios se comprometen y obligan a cumplir como así
          también respetar el reglamento de copropiedad y administración al que
          ...
          vencimiento y el efectivo pago.-
        </p>
        <p className="text-justify">
          CUARTA: siendo intención de las partes mantener el precio del alquiler
          de modo que conserve su valor adquisitivo, convienen que el monto del
